...
//        System.out.println(Arrays.toString(neuralNetwork1.calculate(new double[]{1, 1})));
        ...
        System.out.println(Arrays.toString(network.getLayers()[1].getWeightsAsArray()));
        System.out.println(Arrays.toString(network.getLayers()[2].getWeightsAsArray()));
        network.mutateLayers(0.5);
        System.out.println(Arrays.toString(network.getLayers()[1].getWeightsAsArray()));
        System.out.println(Arrays.toString(network.getLayers()[2].getWeightsAsArray()));
    }
}
